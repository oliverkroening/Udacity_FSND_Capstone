...
'''
Disclaimer: most of the code was adopted from the FSND IAM project
see https://github.com/oliverkroening/Udacity_FSND_Project01/tree/main/projects/03_coffee_shop_full_stack/final_code
'''
